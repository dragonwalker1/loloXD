...
public abstract class WoodenArmorItem extends ArmorItem {
	public WoodenArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends WoodenArmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "colaboration:textures/models/armor/wooden_layer_1.png";
		}
	}
	...
	public static class Leggings extends WoodenArmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "colaboration:textures/models/armor/wooden_layer_2.png";
		}
	}
