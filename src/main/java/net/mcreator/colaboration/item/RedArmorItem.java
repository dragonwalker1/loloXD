...
public abstract class RedArmorItem extends ArmorItem {
	public RedArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends RedArmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "colaboration:textures/models/armor/red_layer_1.png";
		}
	}
	...
	public static class Leggings extends RedArmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "colaboration:textures/models/armor/red_layer_2.png";
		}
	}
